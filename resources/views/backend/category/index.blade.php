            ...
            <table class="table table-bordered" id="banner-dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <img src="http://127.0.0.1:8000/backend/img/thumbnail-default.jpg" class="img-fluid"
                        ...
                        <td>
                            ...
                            <form method="POST" action="http://127.0.0.1:8000/admin/category/4">
                                ...
                                <input type="hidden" name="_method" value="delete"> <button
                                    class="btn btn-danger btn-sm dltBtn" data-id=4
